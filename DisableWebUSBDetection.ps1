<#
.SYNOPSIS
    Disables Web USB Detection in Google Chrome and Microsoft edge for all users.
...
.NOTES
    ...
    Version: 1.1
            1.0: Basic Script
            1.1: Added Set-EdgeFlag to target Microsoft Edge browser 
#> 
...
Set-ChromeFlag -Name "enable-webusb-device-detection" -Value "2" -AllUsers

Set-EdgeFlag -Name "enable-webusb-device-detection" -Value "2" -AllUsers